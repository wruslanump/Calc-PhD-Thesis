...
## set title  "plot2D-calc-u-next-09-u-versus-currfrate-xfrate-yfrate-fratecmd.gp"
...
replot "data_calc_u_next.txt" using 2:16 with lines title "   x-frate"
replot "data_calc_u_next.txt" using 2:17 with lines title "   y-frate"
replot "data_calc_u_next.txt" using 2:18 with lines title " frate-cmd"
