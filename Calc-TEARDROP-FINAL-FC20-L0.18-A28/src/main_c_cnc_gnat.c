...
// GNAT 12.2.0 targeting x86_64-linux-gnu
...
char CurveType[32] = "FC20-L0.18-A28-TEARDROP";
char CurveTypeDesc[80] = "TEARDROP FC=20 LAMDA=0.18 ALGO=28";
...
// ===================================================================  
{
  ...
  proc_writeheader_data_ngc_code (FHdata_ngc_code, CurveTypeDesc, ngc_depth, ngc_scale);
  ...
  while (!loop_u_done)
    {
      ...
      curr_frate_limit = fxn_get_feedrate_limit (rtime, u, u_next,
                 frate_command, t_interpol, curr_rho, curr_eps, lamda_N);
      ...
      next_arc_length = fxn_calc_arc_length (N, u, u_next, next_chordlength, next_eps, next_rho);
...
printf (" BISMILLAH "
        ...
        " \n",
        rtime, u, u_next,
        next_arc_length, next_chordlength,
        sum_arc_length, sum_chordlength,
        diff_arc_chord_length,
        pcnt_diff_arc_chord_length,
        next_arc_theta, sum_arc_theta, 
...
fprintf (FHdata_01, " ALHAMDULILLAH "
   " %6.3lf %.12lf %.12lf "
   " NAL= %.12e NCL= %.12e "
   " SAL= %.12e SCL= %.12e "
   " DAC= %.12e "
...
// ===================================================================   
      ...
      pcnt_diff_arc_chord_length = 100.0 * (diff_arc_chord_length/sum_arc_length);
      
      proc_write_calc_intgr_error (FHdata_calc_intgr_error,
                                   next_arc_length, sum_arc_length,
                                   next_arc_theta, sum_arc_theta,
                                   next_arc_area, sum_arc_area,
                                   rtime, u, u_next, sum_deltaS,
                                   sum_chordlength, diff_arc_chord_length,
                                   pcnt_diff_arc_chord_length);
      ...
      if ((fabs (u_static_after - u_static_before) < 1E-16) && (u_val_constant_1 == 0)) {
          u_val_constant_1 = 1;
          printf(" NOTE: u_val_constant FIRST  occurance of (NO CHANGE IN U) < 1.0E-16) \n");
      }
          
      if ((fabs (u_static_after - u_static_before) < 1E-16) && (u_val_constant_1 == 1)) {
          u_val_constant_2 = 1;
          printf(" NOTE: u_val_constant SECOND occurance of (NO CHANGE IN U) < 1.0E-16) \n");
      }

      if ((fabs (u_static_after - u_static_before) < 1E-16) && (u_val_constant_1 == 1) && (u_val_constant_2 == 1) ) {
          u_val_constant_3 = 1 ;
          printf(" NOTE: u_val_constant THIRD  occurance of (NO CHANGE IN U) < 1.0E-16) \n");
      }
          
      if ((fabs (u_static_after - u_static_before) < 1E-16) && (u_val_constant_1 == 1) && (u_val_constant_2 == 1) && (u_val_constant_3 == 1)) {
          u_val_constant_4 = 1;
          printf(" NOTE: u_val_constant FOURTH occurance of (NO CHANGE IN U) < 1.0E-16) \n");    
      }

      if ((fabs (u_static_after - u_static_before) < 1E-16) && (u_val_constant_1 == 1) && (u_val_constant_2 == 1) && (u_val_constant_3 == 1) && (u_val_constant_4 == 1) ){
          u_val_constant_5 = 1 ;
          printf(" NOTE: u_val_constant FIFTH  occurance of (NO CHANGE IN U) < 1.0E-16)\n");

          printf(" RUN ERROR .... RECURSIVE NON STOP \n");
          printf(" Five(5) consecutive occurances of (NO CHANGE IN U) < 1.0E-16 \n");
      ...
      if ((u_next < 1.0E-14) && (u_next_zero_1 == 0)) {
          u_next_zero_1 = 1;
          printf(" NOTE: u_next_zero FIRST  occurance of (u_next < 1.0E-14)\n");
      }

      if ((u_next < 1.0E-14) && (u_next_zero_1 == 1)) {
          u_next_zero_2 = 1;
          printf(" NOTE: u_next_zero SECOND occurance of (u_next < 1.0E-14)\n");
      }

      if ((u_next < 1.0E-14) && (u_next_zero_1 == 1) && (u_next_zero_2 == 1)) {
          u_next_zero_3 = 1;
          printf(" NOTE: u_next_zero THIRD  occurance of (u_next < 1.0E-14)\n");
      }

      if ((u_next < 1.0E-14) && (u_next_zero_1 == 1) && (u_next_zero_2 == 1) && (u_next_zero_3 == 1)) {
          u_next_zero_4 = 1;
          printf(" NOTE: u_next_zero FOURTH occurance of (u_next < 1.0E-14)\n");
      }

      if ((u_next < 1.0E-14) && (u_next_zero_1 == 1) && (u_next_zero_2 == 1) && (u_next_zero_3 == 1) && (u_next_zero_4 == 1)) {
          u_next_zero_5 = 1;
          printf(" NOTE: u_next_zero FIFTH  occurance of (u_next < 1.0E-14)\n");
