...
## File: plot2D-calc-u-next-07A-u-versus-eps.gp
...
set ylabel "chord error (eps)"
set title  "Plot 2D (u,eps) Chord error (highlevel view) for parametric curve" 

## set title  "plot2D-calc-u-next-07A-u-versus-eps.gp"

# COMMENT RANGES FOR DEFAULT
set xrange [ 0.0 : +1.0]
## set yrange [ 0.00000099 : 0.000001001]
## set yrange [ +9.930E-07   : +1.001E-6]


## PLOT CHECK
plot   "data_calc_u_next.txt" using 2:11 with lines title "(u,eps) point"
