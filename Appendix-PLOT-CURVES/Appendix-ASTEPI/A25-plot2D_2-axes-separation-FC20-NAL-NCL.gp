...
plot "FC20-AstEpi-L018-data_01.txt" using 4:7 axes x1y1 with lines lt 1 lw 2 title "FC20 NAL(u)" ,  "FC20-AstEpi-L018-data_01.txt" using 4:9 axes x2y2 with lines lt 2 lw 2 title "FC20 NCL(u)" 
