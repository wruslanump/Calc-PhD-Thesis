...
set xrange [-80.0 : +80.0]
set yrange [-80.0 : +80.0]
set zrange [0.0 : 1.0]

## 3D-PLOT SnaHyp CHECK

splot "FC20-SnaHyp-L018-data_calc_u_next.txt" using 8:9:2 with lines linecolor black linewidth 2 title "u-direction" 
