...
plot   "FC20-SnaHyp-L018-data_calc_u_next.txt" using 2:5 with lines linewidth 2 title "first-order(u)" 
replot "FC20-SnaHyp-L018-data_calc_u_next.txt" using 2:6 with lines linewidth 2 title "second-order(u)" 


## 3D-PLOT SnaHyp CHECK
