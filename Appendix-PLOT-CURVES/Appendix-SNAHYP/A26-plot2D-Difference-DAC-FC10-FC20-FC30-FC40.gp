...
set ylabel "Difference (SAL - SCL) (mm)"
set xrange [ 0.0 :  + 1.0]   
## set xtics 0.10 
...
plot   "FC10-SnaHyp-L018-data_01.txt" using 4:15 with lines lw 2 title "FC10 Diff DAC(u)" 
replot "FC20-SnaHyp-L018-data_01.txt" using 4:15 with lines lw 2 title "FC20 Diff DAC(u)" 
replot "FC25-SnaHyp-L018-data_01.txt" using 4:15 with lines lw 2 title "FC25 Diff DAC(u)"   
replot "FC28-SnaHyp-L018-data_01.txt" using 4:15 with lines lw 2 title "FC28 Diff DAC(u)" 
