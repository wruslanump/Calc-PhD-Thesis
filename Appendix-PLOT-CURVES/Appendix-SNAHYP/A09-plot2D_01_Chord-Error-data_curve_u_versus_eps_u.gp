...
plot   "FC20-SnaHyp-L018-data_calc_u_next.txt" using 2:11 axes x1y1 with lines lw 2 title "(u, eps(u))" 
replot "FC20-SnaHyp-L018-data_calc_u_next.txt" using 2:11 axes x2y2 with lines lt 2 lw 2 title "close view (u, eps(u)" 
