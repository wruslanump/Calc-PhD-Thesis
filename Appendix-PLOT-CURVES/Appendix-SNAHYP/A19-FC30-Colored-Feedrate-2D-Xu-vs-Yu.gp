...
# CHANGE PART 1 OF 3
set output "19-img-SnaHyp-FC25-Colored-Feedrate-Profile-data_ngcode.png"

# CHANGE PART 2 OF 3
set title  "SnaHyp FC25 L018 Feedrate Colored Profile  (Color scale = Feedrate)" 

## ==================================================================
set xlabel "position x(u)"
set xrange [ -80.00000 : +80.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse writeback

set ylabel "position y(u)"
set yrange [ -80.0000 : +80.0000 ] noreverse nowriteback
...
## CHANGE PART 3 OF 3
plot  'FC25-SnaHyp-L018-data_ngcode.ngc' using 5:7:3 with lines linewidth 3 linecolor palette title "(x(u), y(u)) point"
