...
plot    "FC20-SnaHyp-L018-data_calc_u_next.txt" using 2:12  axes x1y1 with lines lt 1 lw 2 title "(u, rho(u))" 
## replot  "FC20-SnaHyp-L018-data_calc_u_next.txt" using 2:12  axes x2y2 with lines lt 2 lw 2 title "Log 10 view (u, rho(u))" 
