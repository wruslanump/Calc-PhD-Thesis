...
set yrange [ 0.00000 : 8000. ] noreverse writeback
...
set xtics ("[0.0 - 0.1)" 0, "[0.1 - 0.2)" 1, "[0.2 - 0.3)" 2, "[0.3 - 0.4)" 3, "[0.4 - 0.5)" 4, "[0.5 - 0.6)" 5, "[0.6 - 0.7)" 6, "[0.7 - 0.8)" 7, "[0.8 - 0.9)" 8, "[0.9 - 1.0)" 9)

plot 'data-for-CIRCLE-histogram.txt' using 1:xtic(1) title "BINS", '' using 2 title "FC10", '' using 3 title "FC20", '' using 4 title "FC30", '' using 5 title "FC40"
