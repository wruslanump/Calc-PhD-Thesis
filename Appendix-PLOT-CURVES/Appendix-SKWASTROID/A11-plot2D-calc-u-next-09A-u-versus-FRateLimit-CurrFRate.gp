...
plot   "FC20-SkwAstroid-L018-data_calc_u_next.txt" using 2:18 with lines linewidth 2   title "frate-command(u)"
replot "FC20-SkwAstroid-L018-data_calc_u_next.txt" using 2:15 with lines linewidth 2   title "  frate-limit(u)"
replot "FC20-SkwAstroid-L018-data_calc_u_next.txt" using 2:14 with lines linewidth 2   title "   curr-frate(u)"
