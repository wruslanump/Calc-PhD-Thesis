...
# CHANGE PART 1 OF 3
set output "17-img-SkwAstroid-FC10-Colored-Feedrate-Profile-data_ngcode.png"

# CHANGE PART 2 OF 3
set title  "SkwAstroid FC10 L018 Feedrate Colored Profile  (Color scale = Feedrate)" 
...
set palette defined ( 0 'purple', 2 'blue', 4 'green', 6 'yellow', 8 'orange', 10 'red' )

#  FIXED RANGE COLOR FIXED - NOT AUTORANGE (WHICH TAKES (MAX, MIN))
set cbrange [0:10] noreverse writeback
...
## CHANGE PART 3 OF 3
plot  'FC10-SkwAstroid-L018-data_ngcode.ngc' using 5:7:3 with lines linewidth 2 linecolor palette title "(x(u), y(u)) point"
