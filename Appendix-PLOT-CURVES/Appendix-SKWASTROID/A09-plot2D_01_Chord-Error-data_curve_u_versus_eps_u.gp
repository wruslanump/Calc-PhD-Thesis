...
set x2range [ 0.0 :  + 1.0]  
set y2range [ 1E-9 : 60E-9]  
set format y2 "%1.2sx10^{%T}"   
set y2tics 1E-8  nomirror tc lt 2
set y2label "Close View Chord-error eps(u)"  
    

plot   "FC20-SkwAstroid-L018-data_calc_u_next.txt" using 2:11 axes x1y1 with lines lw 2 title "(u, eps(u))" 
replot "FC20-SkwAstroid-L018-data_calc_u_next.txt" using 2:11 axes x2y2 with lines lt 2 lw 2 title "close view (u, eps(u)" 
