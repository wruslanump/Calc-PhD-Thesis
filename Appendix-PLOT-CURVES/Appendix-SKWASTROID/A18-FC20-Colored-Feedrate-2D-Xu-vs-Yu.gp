...
# CHANGE PART 1 OF 3
set output "18-img-SkwAstroid-FC20-Colored-Feedrate-Profile-data_ngcode.png"

# CHANGE PART 2 OF 3
set title  "SkwAstroid FC20 L018 Feedrate Colored Profile  (Color scale = Feedrate)" 
...
set palette defined ( 0 'purple', 4 'blue', 8 'green', 12 'yellow', 16 'orange', 20 'red' )

#  FIXED RANGE COLOR FIXED - NOT AUTORANGE (WHICH TAKES (MAX, MIN))
set cbrange [0:20] noreverse writeback
...
## CHANGE PART 3 OF 3
plot  'FC20-SkwAstroid-L018-data_ngcode.ngc' using 5:7:3 with lines linewidth 2 linecolor palette title "(x(u), y(u)) point"
