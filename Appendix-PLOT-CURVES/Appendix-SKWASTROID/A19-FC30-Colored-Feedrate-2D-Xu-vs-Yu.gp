...
# CHANGE PART 1 OF 3
set output "19-img-SkwAstroid-FC30-Colored-Feedrate-Profile-data_ngcode.png"

# CHANGE PART 2 OF 3
set title  "SkwAstroid FC30 L018 Feedrate Colored Profile  (Color scale = Feedrate)" 

## ==================================================================
set xlabel "position x(u)"
set xrange [ -120.00000 : +120.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse writeback

set ylabel "position y(u)"
set yrange [ -120.0000 : +120.0000 ] noreverse nowriteback
...
set palette defined ( 0 'purple', 6 'blue', 12 'green', 18 'yellow', 24 'orange', 30 'red' )

#  FIXED RANGE COLOR FIXED - NOT AUTORANGE (WHICH TAKES (MAX, MIN))
set cbrange [0:30] noreverse writeback
...
## CHANGE PART 3 OF 3
plot  'FC30-SkwAstroid-L018-data_ngcode.ngc' using 5:7:3 with lines linewidth 3 linecolor palette title "(x(u), y(u)) point"
