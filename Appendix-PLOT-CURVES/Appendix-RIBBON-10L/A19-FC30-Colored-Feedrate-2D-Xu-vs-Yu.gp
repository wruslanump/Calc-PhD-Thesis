...
# CHANGE PART 1 OF 3
set output "19-img-Ribbon-10L-FC30-Colored-Feedrate-Profile-data_ngcode.png"

# CHANGE PART 2 OF 3
set title  "Ribbon-10L FC30 L018 Feedrate Colored Profile  (Color scale = Feedrate)" 

## ==================================================================
set xlabel "position x(u)"
set xrange [ -10.00000 : +10.0000 ] noreverse nowriteback
...
## CHANGE PART 3 OF 3
plot  'FC30-Ribbon-10L-L018-data_ngcode.ngc' using 5:7:3 with lines linewidth 3 linecolor palette title "(x(u), y(u)) point"
