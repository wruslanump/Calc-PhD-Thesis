...
plot "FC20-Ribbon-10L-L018-data_calc_u_next.txt" using 2:5 axes x1y1 with lines lt 1 lw 2 title "first-order" ,  "FC20-Ribbon-10L-L018-data_calc_u_next.txt" using 2:6 axes x2y2 with lines lt 2 lw 2 title "second-order" 
