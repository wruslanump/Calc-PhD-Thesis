...
set multiplot layout 2,1 columns
	...
	set title "Lamda0.18 Ellipse FC10"
    plot "FC10-Ellipse-L018-data_calc_u_next.txt" using 2:13 with lines lw 2 linecolor black title "tang-accn"

    set xrange [ 0.50 :  + 1.00]
    set yrange [ -50.00 :  +50.00]
	set title "continue Lamda0.18 Ellipse FC10"
    plot "FC10-Ellipse-L018-data_calc_u_next.txt" using 2:13 with lines lw 2 linecolor black title "tang-accn"
