...
plot "FC20-Ellipse-L018-data_01.txt" using 4:11 axes x1y1 with lines lt 1 lw 2 title "SAL(u)" ,  "FC20-Ellipse-L018-data_01.txt" using 4:13 axes x2y2 with lines lt 2 lw 2 title "SCL(u)" 
