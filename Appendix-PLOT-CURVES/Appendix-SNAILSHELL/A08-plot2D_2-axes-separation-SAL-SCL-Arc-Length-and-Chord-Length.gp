...
set xrange [ 0.0 :  + 1.0]   
set yrange [-20.00000 : 300.00]  

set x2range [ 0.0 :  + 1.0]  
set y2range [ 0.0 : +320.00]  
...
plot "FC20-Snailshell-L018-data_01.txt" using 4:11 axes x1y1 with lines lt 1 lw 2 title "SAL(u)" ,  "FC20-Snailshell-L018-data_01.txt" using 4:13 axes x2y2 with lines lt 2 lw 2 title "SCL(u)" 
