...
# CHANGE PART 1 OF 3
set output "19-img-Snailshell-FC30-Colored-Feedrate-Profile-data_ngcode.png"

# CHANGE PART 2 OF 3
set title  "Snailshell FC30 L018 Feedrate Colored Profile  (Color scale = Feedrate)" 

## ==================================================================
set xlabel "position x(u)"
set xrange [ -30.00000 : +30.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse writeback

set ylabel "position y(u)"
set yrange [ -30.00000 : +30.0000 ] noreverse nowriteback
...
## CHANGE PART 3 OF 3
plot  'FC30-Snailshell-L018-data_ngcode.ngc' using 5:7:3 with lines linewidth 3 linecolor palette title "(x(u), y(u)) point"
