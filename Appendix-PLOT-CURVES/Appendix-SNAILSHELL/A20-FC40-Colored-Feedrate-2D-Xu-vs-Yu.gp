...
# CHANGE PART 1 OF 3
set output "20-img-Snailshell-FC40-Colored-Feedrate-Profile-data_ngcode.png"

# CHANGE PART 2 OF 3
set title  "Snailshell FC40 L018 Feedrate Colored Profile  (Color scale = Feedrate)" 
...
## CHANGE PART 3 OF 3
plot  'FC40-Snailshell-L018-data_ngcode.ngc' using 5:7:3 with lines linewidth 3 linecolor palette title "(x(u), y(u)) point"
