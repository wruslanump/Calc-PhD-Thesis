...
plot   "FC20-Butterfly-L018-data_calc_u_next.txt" using 2:5 with lines linewidth 2 title "first-order(u)" 
replot "FC20-Butterfly-L018-data_calc_u_next.txt" using 2:6 with lines linewidth 2 title "second-order(u)" 
