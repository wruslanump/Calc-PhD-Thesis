...
set xrange [ 0.0 :  + 1.0]   
set yrange [0.00001 : 0.00035]  

set x2range [ 0.0 :  + 1.0]  
set y2range [0.00001 : 0.00045]  
...
plot "FC20-Butterfly-L018-data_calc_u_next.txt" using 2:5 axes x1y1 with lines lt 1 lw 2 title "first-order" ,  "FC20-Butterfly-L018-data_calc_u_next.txt" using 2:6 axes x2y2 with lines lt 2 lw 2 title "second-order" 
