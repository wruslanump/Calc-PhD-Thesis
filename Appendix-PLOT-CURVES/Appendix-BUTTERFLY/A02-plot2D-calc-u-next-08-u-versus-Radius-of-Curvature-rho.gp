...
set y2range [ 0  : 1E+7]    # DEFAULT

set ytics 2.5E+1 nomirror tc lt 1
set ylabel "Radius of Curvature rho(u)"


set y2tics 1E+1 nomirror tc lt 2
set y2label "Log 10 Radius of Curvature rho(u)"
  
plot    "FC20-Butterfly-L018-data_calc_u_next.txt" using 2:12  axes x1y1 with lines lt 1 lw 2 title "(u, rho(u))" 
replot  "FC20-Butterfly-L018-data_calc_u_next.txt" using 2:12  axes x2y2 with lines lt 2 lw 2 title "Log 10 view (u, rho(u))" 
