...
plot   "FC10-Circle-L018-data_01.txt" using 4:15 with lines lw 2 title "FC10 Diff DAC(u)" 
replot "FC20-Circle-L018-data_01.txt" using 4:15 with lines lw 2 title "FC20 Diff DAC(u)" 
replot "FC30-Circle-L018-data_01.txt" using 4:15 with lines lw 2 title "FC30 Diff DAC(u)"   
replot "FC40-Circle-L018-data_01.txt" using 4:15 with lines lw 2 title "FC40 Diff DAC(u)" 
