...
set x2range [ 0.0 :  + 1.0]  
set y2range [ 9.9E-7 : 1.006E-6]  

set format y2 "%1.2sx10^{%T}"   
set y2tics 0.010E-7  nomirror tc lt 2
set y2label "Close View Chord-error eps(u)"  
    

plot   "FC20-Ribbon-100L-L018-data_calc_u_next.txt" using 2:11 axes x1y1 with lines lw 2 title "(u, eps(u))" 
replot "FC20-Ribbon-100L-L018-data_calc_u_next.txt" using 2:11 axes x2y2 with lines lt 2 lw 2 title "close view (u, eps(u)" 
