...
# CHANGE PART 1 OF 3
set output "19-img-Ribbon-100L-FC30-Colored-Feedrate-Profile-data_ngcode.png"

# CHANGE PART 2 OF 3
set title  "Ribbon-100L FC30 L018 Feedrate Colored Profile  (Color scale = Feedrate)" 

## ==================================================================
set xlabel "position x(u)"
set xrange [ -60.00000 : +60.0000 ] noreverse nowriteback
...
## CHANGE PART 3 OF 3
plot  'FC30-Ribbon-100L-L018-data_ngcode.ngc' using 5:7:3 with lines linewidth 3 linecolor palette title "(x(u), y(u)) point"
