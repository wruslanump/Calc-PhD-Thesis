...
set y2range [ * : 1000 ] noreverse writeback
...
plot 'data-for-RIBBON-100L-histogram.txt' using 1 title "FC10", '' using 2 title "FC20", '' using 3 title "FC30", '' using 4 title "FC40"
