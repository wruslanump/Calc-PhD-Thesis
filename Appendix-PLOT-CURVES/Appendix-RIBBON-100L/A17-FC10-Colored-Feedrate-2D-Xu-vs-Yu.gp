...
# CHANGE PART 1 OF 3
set output "17-img-Ribbon-100L-FC10-Colored-Feedrate-Profile-data_ngcode.png"

# CHANGE PART 2 OF 3
set title  "Ribbon-100L FC10 L018 Feedrate Colored Profile  (Color scale = Feedrate)" 
...
## CHANGE PART 3 OF 3
plot  'FC10-Ribbon-100L-L018-data_ngcode.ngc' using 5:7:3 with lines linewidth 2 linecolor palette title "(x(u), y(u)) point"
