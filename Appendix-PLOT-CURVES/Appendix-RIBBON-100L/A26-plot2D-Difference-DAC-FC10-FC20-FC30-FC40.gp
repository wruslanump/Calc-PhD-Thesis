...
plot   "FC10-Ribbon-100L-L018-data_01.txt" using 4:15 with lines lw 2 title "FC10 Diff DAC(u)" 
replot "FC20-Ribbon-100L-L018-data_01.txt" using 4:15 with lines lw 2 title "FC20 Diff DAC(u)" 
replot "FC30-Ribbon-100L-L018-data_01.txt" using 4:15 with lines lw 2 title "FC30 Diff DAC(u)"   
replot "FC40-Ribbon-100L-L018-data_01.txt" using 4:15 with lines lw 2 title "FC40 Diff DAC(u)" 
