...
set x2range [ 0.0 :  + 1.0]  
set y2range [ 0.000 : 1.8E-3]  
## set y2range [ * : * ]  

set ytics 1E-4 nomirror tc lt 1
set ylabel "first-order Taylors approx"

set y2tics 1E-4  nomirror tc lt 2
set y2label "second-order Taylors approx"
    

plot   "FC20-Ribbon-100L-L018-data_calc_u_next.txt" using 2:5 axes x1y1 with lines lt 1 lw 2 title "first-order"  
replot "FC20-Ribbon-100L-L018-data_calc_u_next.txt" using 2:6 axes x2y2 with lines lt 2 lw 2 title "second-order" 
