...
plot 'data-for-ELLIPSE-histogram.txt' using 1:xtic(1) title "BINS", '' using 2 title "FC10", '' using 3 title "FC20", '' using 4 title "FC30", '' using 5 title "FC40"
