...
## File: plot2D-calc-u-next-02-RIGHT-u-versus-u-next.gp
...
set title  "Plot 2D (u, u-next) Right edge interpolated parametric curve points" 

## set title  "plot2D-calc-u-next-02-RIGHT-u-versus-u-next.gp"

# COMMENT RANGES FOR DEFAULT
set xrange [ +0.99 : +1.00] 
