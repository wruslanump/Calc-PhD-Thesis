...
char CurveType[32] = "FC30-L0.18-A28-TEARDROP";
char CurveTypeDesc[80] = "TEARDROP FC=30 LAMDA=0.18 ALGO=28 SKIP STEP2 RUN-STEP1";

// COMMENT LINE BELOW IF NOT CIRCLE
// FOR VALIDATION OF CIRCUMFERENCE = sum_chord_length
// AND TOTAL ANGLE 2PI RADIANS     = sum_arc_theta
// <<<<======================== NOTE
...
// =================================================================
void debug_function_01_find_negatives (double rtime, double u, double u_next,
                                       double sum_arc_length,
                                       double sum_chordlength,
                                       double diff_arc_chord_length, double next_arc_length, double next_chordlength);

void
debug_function_01_find_negatives (double rtime, double u, double u_next,
                                  double sum_arc_length, double sum_chordlength,
                                  double diff_arc_chord_length, double next_arc_length, double next_chordlength)
{
  // printf ("Start debug_function_01_find_negatives() TO-SCREEN \n");

  printf ("DEBUG %6.3lf %.12lf %.12lf %.12e %.12e %.12e %.12e %.12e \n", rtime, u, u_next,
          sum_arc_length, sum_chordlength, (sum_arc_length - sum_chordlength), next_arc_length, next_chordlength );

  double SAL = sum_arc_length;
  double SCL = sum_chordlength;

  if ((SAL - SCL) <= 0.000)
    {
      printf ("TRAPPED (SAL-SCL) <= 0.000 \n");
      printf ("TRAPPED (SAL-SCL) = %.12e  \n", (SAL - SCL));
      printf ("EXIT(1) \n");
      exit (1);
    }

  // printf ("Finish debug_function_01_find_negatives() TO-SCREEN \n");
}

// =================================================================
// (1) FIX FOR(RECURSIVE NON STOP)
// EXAMPLE WHEN u NOT CHANGING 5 CONSECUTIVE OCCURANCES
int u_val_constant_1 = 0;
int u_val_constant_2 = 0;
int u_val_constant_3 = 0;
int u_val_constant_4 = 0;
int u_val_constant_5 = 0;
// (2) FIX FOR (RECURSIVE NON STOP)
// EXAMPLE WHEN u_next = 0.000000000000000 5 CONSECUTIVE OCCURANCES
int u_next_zero_1 = 0;
int u_next_zero_2 = 0;
int u_next_zero_3 = 0;
int u_next_zero_4 = 0;
...
// (3) FIX FOR (RECURSIVE NON STOP)
int line_count_limit;

int display_line_limit_03K_BELOW = 0;
int display_line_limit_03K = 0;
int display_line_limit_05K = 0;
int display_line_limit_10K = 0;
int display_line_limit_15K = 0;
int display_line_limit_20K = 0;
int display_line_limit_25K = 0;
int display_line_limit_30K = 0;
int display_line_limit_35K = 0;
int display_line_limit_40K = 0;
int display_line_limit_45K = 0;
int display_line_limit_50K = 0;
int display_line_limit_50K_ABOVE = 0;
int display_line_limit_100K_ABOVE = 0;
int display_line_limit_200K_ABOVE = 0;

// CHANGE THIS LAST LIMIT IF REQUIRED (1 million)
int LAST_LINE_LIMIT = 1000000;

void proc_display_exit_status ();
// ==================================================================
void
proc_display_exit_status ()
{
  // ==================================================================
  printf (" STATUS: 0 = NOT ACTIVATED, 1 ACTIVATED \n");
  // printf (" \n");

  printf ("EXIT ON u VALUE NOT CHANGING CONSECUTIVELY\n");
  printf ("u_val_constant_1 = %d \n", u_val_constant_1);
  printf ("u_val_constant_2 = %d \n", u_val_constant_2);
  printf ("u_val_constant_3 = %d \n", u_val_constant_3);
  printf ("u_val_constant_4 = %d \n", u_val_constant_4);
  printf ("u_val_constant_5 = %d \n", u_val_constant_5);

  printf ("EXIT ON u_next VALUE BECOMES ZERO CONSECUTIVELY\n");
  printf ("u_next_zero_1 = %d \n", u_next_zero_1);
  printf ("u_next_zero_2 = %d \n", u_next_zero_2);
  printf ("u_next_zero_3 = %d \n", u_next_zero_3);
  printf ("u_next_zero_4 = %d \n", u_next_zero_4);
  printf ("u_next_zero_5 = %d \n", u_next_zero_5);

  printf ("EXIT ON INTERPOLATED POINTS EXCEEDING 50,000 LINE LIMIT\n");
  printf ("display_line_limit_03K_BELOW = %d \n", display_line_limit_03K_BELOW);
  printf ("display_line_limit_03K = %d \n", display_line_limit_03K);
  printf ("display_line_limit_05K = %d \n", display_line_limit_05K);
  printf ("display_line_limit_10K = %d \n", display_line_limit_10K);
  printf ("display_line_limit_15K = %d \n", display_line_limit_15K);
  printf ("display_line_limit_20K = %d \n", display_line_limit_20K);
  printf ("display_line_limit_25K = %d \n", display_line_limit_25K);
  printf ("display_line_limit_30K = %d \n", display_line_limit_30K);
  printf ("display_line_limit_35K = %d \n", display_line_limit_35K);
  printf ("display_line_limit_40K = %d \n", display_line_limit_40K);
  printf ("display_line_limit_45K = %d \n", display_line_limit_45K);
  printf ("display_line_limit_50K = %d \n", display_line_limit_50K);
  printf ("display_line_limit_50K_ABOVE = %d \n", display_line_limit_50K_ABOVE);
  printf ("display_line_limit_100K_ABOVE = %d \n",
...
// double const frate_command = 20.0; // mm/s
double const frate_command = 30.0; // mm/s
// double const frate_command = 34.0; // mm/s
// double const frate_command = 40.0; // mm/s
//
// FEEDRATE LIMIT-4 FOR ACCN
// double const lamda_N = 0.10; // A constant safety factor (0.0 : 1.0)
double const lamda_N = 0.18; // A constant safety factor (0.0 : 1.0)
// double const lamda_N = 0.20; // A constant safety factor (0.0 : 1.0)
// double const lamda_N = 0.50; // A constant safety factor (0.0 : 1.0)
//
...
// ARC_LENGTH, ARC_THETA ARC_AREA
double curr_arc_length = 0.0;
double next_arc_length = 0.0;
double curr_arc_theta = 0.0;
double next_arc_theta = 0.0;
double curr_arc_area = 0.0;
double next_arc_area = 0.0;

double sum_arc_length = 0.0;
double sum_arc_theta = 0.0;
double sum_arc_area = 0.0;

double diff_arc_chord_length = 0.0;
double pcnt_diff_arc_chord_length = 0.0;
  ...
  while (!loop_u_done)
    {
      ...
      // DISPLAY TO SCREEN.
      printf ("%s ", CurveType);
      printf (" %5.3lf %12.9lf %12.9lf %6.3lf %.6e  %.6e  %.6e  %7.3lf %7.3lf "
              "%7.3lf  %.6e %10.6lf %10.6lf %10.6lf %10.6lf %12.9lf %10.6lf "
              "%10.6lf %6.2lf",
              rtime, u, u_next, t_interpol, curr_unext1stOrder,
              curr_unext2ndOrder, (curr_unext1stOrder - curr_unext2ndOrder),
              fxn_cpos_x (u), fxn_cpos_y (u), fxn_cpos_r (u), curr_eps,
              curr_rho, curr_tang_accn, curr_frate_limit, curr_frate,
              (curr_frate_limit - curr_frate), curr_xfrate, curr_yfrate,
              frate_command);
      ...
      // ********************************************
      // ALWAYS GUARANTEE u MOVES FORWARD (ALWAYS POSITIVE - use fabs())
      // THIS IS THE NEW VALUE FOR u_next
      u_next = fabs (u_next);
      ...
      // ===========================================================
      // ACCUMULATE ARC LENGTHS, ARC_THETA, ARC_AREA
      // IMPT: CODES INSIDE: curves/c_position.c
      // ===========================================================
      printf ("\n");

      // *********************************************************
      // NaN, an acronym for Not a Number is an exception that usually
      // occurs in the cases when an expression results in a number that
      // is undefined or can't be represented. It is used for floating-point
      // operations. For example: The square root of negative numbers.
      // Division by zero.
      //

      // ==========================================================
      // GOOD PART 1 sum_arc_length (Using curve equation itself)
      // ==========================================================

      next_arc_length = fxn_calc_arc_length (N, u, u_next, next_chordlength,
                                             next_eps, next_rho);
      // printf ("GOOD MAIN RECVD: next_arc_length \t= %.12e (mm)\n",
      // next_arc_length);

      // INCREMENT SUM ARC LENGTH
      sum_arc_length = sum_arc_length + next_arc_length;

      // isnan (sum_arc_length)
      //  ? printf ("sum_arc_length is NaN \t\t== Not a Number \n")
      //  : printf ("sum_arc_length is \t\t= REAL \n");

      // printf ("CORRECT MAIN OUTPUT: sum_arc_length \t= %.12e (mm)\n",
      // sum_arc_length);

      diff_arc_chord_length = (sum_arc_length - sum_chordlength);

      
      // ==========================================================
      // GOOD PART 2 sum_arc_theta
      // ==========================================================
      next_arc_theta
        = fxn_calc_arc_theta (N, u, next_chordlength, next_eps, next_rho);
      // printf("MAIN OUTPUT: next_arc_theta \t= %.12e rad.\n", next_arc_theta);

      sum_arc_theta = sum_arc_theta + next_arc_theta;
      // printf ("CORRECT MAIN OUTPUT: sum_arc_theta \t= %.12e (rad)\n",
      // sum_arc_theta);

      // ==========================================================
      // GOOD PART 3 sum_arc_area
      // ==========================================================
      next_arc_area
        = fxn_calc_arc_area (N, u, next_chordlength, next_eps, next_rho);
      // printf("MAIN OUTPUT: next_arc_area \t\t= %.12e (mm2)\n",
      // next_arc_area);

      sum_arc_area = sum_arc_area + next_arc_area;
      // printf ("CORRECT MAIN OUTPUT: sum_arc_area \t= %.12e (mm2)\n",
      // sum_arc_area);
      ...
      next_rho = fxn_cpos_rho (u + u_next / 2.0);
      ...
      // ===================================================================
      // DEBUGGING FUNCTION 01 (DISPLAY TO SCREEN
      // ===================================================================

      // EXECUTE DEBUG FUNCTION (EVERY LOOP)
      

      // debug_function_01_find_negatives (rtime, u, u_next, sum_arc_length, sum_chordlength,
      //                diff_arc_chord_length, next_arc_length, next_chordlength);

      
      // ==========================================================
      // WRITE TO SCREEN FOR DEBUGGING (SAME AS data_01.txt)
      ...
      printf (" BISMILLAH "
              ...
              " NAA= %.12e SAA= %.12e "
              " \n",
              rtime, u, u_next, next_arc_length, next_chordlength,
               sum_arc_length, sum_chordlength, (sum_arc_length - sum_chordlength),
               100.0*(sum_arc_length - sum_chordlength)/sum_arc_length, next_arc_theta, sum_arc_theta,
               next_arc_area, sum_arc_area);

      */

      // WRITE TO FILE 01 (data_01.txt) FOR DEBUGGING
      ...
      diff_arc_chord_length = (sum_arc_length - sum_chordlength);
      pcnt_diff_arc_chord_length
        = 100.0 * (diff_arc_chord_length / sum_arc_length);

      proc_write_calc_intgr_error (
        FHdata_calc_intgr_error, next_arc_length, sum_arc_length,
        next_arc_theta, sum_arc_theta, next_arc_area, sum_arc_area, rtime, u,
        u_next, sum_deltaS, sum_chordlength, diff_arc_chord_length,
        pcnt_diff_arc_chord_length);
      ...
      double u_static_before = u;
      u = u + u_next;
      double u_static_after = u;
      ...
      curr_arc_length = next_arc_length;
      curr_arc_theta = next_arc_theta;
      curr_arc_area = next_arc_area;

      

      // =============================================================
      // (1) VERY IMPORTANT FIX (RECURSIVE NON STOP)
      // EXAMPLE WHEN u_next = 0.000000000000000 5 CONSECUTIVE OCCURANCES

      if ((fabs (u_static_after - u_static_before) < 1E-16)
          && (u_val_constant_1 == 0))
        {
          u_val_constant_1 = 1;
          printf (" NOTE: u_val_constant FIRST  occurance of (NO CHANGE IN U) "
                  "< 1.0E-16) \n");
        }
      ...
      if ((fabs (u_static_after - u_static_before) < 1E-16)
        ...
        {
          u_val_constant_2 = 1;
          printf (" NOTE: u_val_constant SECOND occurance of (NO CHANGE IN U) "
                  "< 1.0E-16) \n");
        }

      if ((fabs (u_static_after - u_static_before) < 1E-16)
          && (u_val_constant_1 == 1) && (u_val_constant_2 == 1))
        {
          u_val_constant_3 = 1;
          printf (" NOTE: u_val_constant THIRD  occurance of (NO CHANGE IN U) "
                  "< 1.0E-16) \n");
        }
      ...
      if ((fabs (u_static_after - u_static_before) < 1E-16)
        ...
        {
          u_val_constant_4 = 1;
          printf (" NOTE: u_val_constant FOURTH occurance of (NO CHANGE IN U) "
                  "< 1.0E-16) \n");
        }

      if ((fabs (u_static_after - u_static_before) < 1E-16)
          && (u_val_constant_1 == 1) && (u_val_constant_2 == 1)
          && (u_val_constant_3 == 1) && (u_val_constant_4 == 1))
        {
          u_val_constant_5 = 1;
          printf (" NOTE: u_val_constant FIFTH  occurance of (NO CHANGE IN U) "
                  "< 1.0E-16)\n");

          printf (" RUN ERROR .... RECURSIVE NON STOP \n");
          printf (
            " Five(5) consecutive occurances of (NO CHANGE IN U) < 1.0E-16 \n");

          printf (" Execute exit(1) at line 1273 in main(). \n");
      ...
      // ==========================================================
      // (2) VERY IMPORTANT FIX (RECURSIVE NON STOP)
      // EXAMPLE WHEN u_next = 0.000000000000000 5 CONSECUTIVE OCCURANCES

      if ((u_next < 1.0E-14) && (u_next_zero_1 == 0))
        {
          u_next_zero_1 = 1;
          printf (
      ...
      if ((u_next < 1.0E-14) && (u_next_zero_1 == 1))
        {
          u_next_zero_2 = 1;
          printf (
      ...
      if ((u_next < 1.0E-14) && (u_next_zero_1 == 1) && (u_next_zero_2 == 1))
        {
          u_next_zero_3 = 1;
          printf (
      ...
      if ((u_next < 1.0E-14) && (u_next_zero_1 == 1) && (u_next_zero_2 == 1)
          && (u_next_zero_3 == 1) && (u_next_zero_4 == 1))
        {
          u_next_zero_5 = 1;
          printf (
          ...
          printf (" RUN ERROR .... RECURSIVE NON STOP \n");
          printf (" Five(5) consecutive occurances of (u_next < 1.0E-14) \n");

          printf (" Execute exit(1) at line 1310 in main(). \n");
      ...
      // ==========================================================
      // (3) VERY IMPORTANT FIX (RECURSIVE NON STOP)
      // EXAMPLE WHEN u_next = 0.000000000000000

      line_count_limit = (int)(rtime * 1000);

      if (line_count_limit < 3000)
        {
          display_line_limit_03K_BELOW = 1;
        }

      switch (line_count_limit)
        {
        case 3000:
        ...
        case 10000:
          ...
          break;
        case 15000:
          display_line_limit_15K = 1;
          break;
        case 20000:
          display_line_limit_20K = 1;
          break;
        case 25000:
          display_line_limit_25K = 1;
          break;
        case 30000:
          display_line_limit_30K = 1;
          break;
        case 35000:
          display_line_limit_35K = 1;
          break;
        case 40000:
          display_line_limit_40K = 1;
          break;
        case 45000:
          display_line_limit_45K = 1;
          break;
        case 50000:
          display_line_limit_50K = 1;
          break;
      ...
      if (line_count_limit > 50000)
        {

          display_line_limit_50K_ABOVE = 1;
        }
      if (line_count_limit > 100000)
        {

          display_line_limit_100K_ABOVE = 1;
        }

      if (line_count_limit > LAST_LINE_LIMIT)
        {

          display_line_limit_200K_ABOVE = 1;
          printf (" RUN ERROR .... RECURSIVE NON STOP EXECUTION \n");
          printf (" More than 200,000 lines generated \n");
          printf (" Execute exit(1) at line 1380 in main(). \n");
      ...
      if (u >= u_ended)
        {
          ...
          // TO FIX LAST LINE SAL
          next_arc_length = fxn_calc_arc_length ( N, u_beforelast, u_next, next_chordlength, next_eps, next_rho);

          // TO FIX LAST LINE SCL
          ...
          proc_write_calc_intgr_error (
            FHdata_calc_intgr_error, next_arc_length, sum_arc_length,
            next_arc_theta, sum_arc_theta, next_arc_area, sum_arc_area, rtime,
            u, u_next, sum_deltaS, sum_chordlength,
            diff_arc_chord_length, pcnt_diff_arc_chord_length);
...
// ===================================================================
 ...
 // EXECUTE DEBUG FUNCTION (LAST POINT)
...
// ===================================================================   
  ...
  proc_write_09_write_algorithm_efficiency_statistics (
    FHdata_02, CurveType, N, sum_chordlength, sum_eps, sum_arc_length,
    sum_arc_theta, sum_arc_area,
    diff_arc_chord_length, pcnt_diff_arc_chord_length);
