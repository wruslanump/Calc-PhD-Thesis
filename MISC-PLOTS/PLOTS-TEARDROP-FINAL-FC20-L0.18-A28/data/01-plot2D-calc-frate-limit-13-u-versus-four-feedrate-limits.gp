...
plot   "data_calc_u_next.txt" using 2:18 with linespoint      title "limit-1 User Frate Command"
replot "data_calc_frate_limit.txt" using 2:5 with linespoint  title "limit-2 Max/Min Machine Velocity"
replot "data_calc_frate_limit.txt" using 2:6 with linespoint  title "limit-3 Error Contour Accuracy"
replot "data_calc_frate_limit.txt" using 2:7 with linespoint  title "limit-4 Acceleration confinement"
