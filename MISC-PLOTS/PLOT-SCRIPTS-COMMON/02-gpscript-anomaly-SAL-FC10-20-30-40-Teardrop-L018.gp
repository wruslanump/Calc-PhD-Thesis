...
set title "Plot2D curve (u) vs Teardrop Difference (SAL(u) - SCL(u))"

set xrange [0.0 : 1.0]
set yrange [0.000 : 0.012]


  plot "data-anomaly-FC10-Teardrop-L018-data_01.txt" using 4:15 with lines  linewidth 2 title "FC10 DIFF (SAL - SCL)" 
replot "data-anomaly-FC20-Teardrop-L018-data_01.txt" using 4:15 with lines  linewidth 2 title "FC20 DIFF (SAL - SCL)" 
replot "data-anomaly-FC30-Teardrop-L018-data_01.txt" using 4:15 with lines  linewidth 2 title "FC30 DIFF (SAL - SCL)" 
replot "data-anomaly-FC40-Teardrop-L018-data_01.txt" using 4:15 with lines  linewidth 2 title "FC40 DIFF (SAL - SCL)" 
